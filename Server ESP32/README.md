...
1. เข้าไปที่โฟลเดอร์ `esp32/`
2. คัดลอกไฟล์ `config.example.h` เป็น `config.h`
3. แก้ไขข้อมูล WiFi SSID, Password และ GitHub Token ของคุณ
4. เปิดไฟล์ `esp32_github_client.ino` ด้วย **Arduino IDE**
